...
--
-- Banco de dados: `vitor_financeiro`
--
CREATE DATABASE IF NOT EXISTS `vitor_financeiro` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `vitor_financeiro`;
...
CREATE TABLE `produtos` (
  ...
  `Descreicao` varchar(50) DEFAULT NULL,
...
INSERT INTO `produtos` (`Referencia`, `Descreicao`, `Estoque`) VALUES
('001', 'Feijão', 10),
('002', 'Arroz', 5),
('003', 'Farinha', 15);
...
ALTER TABLE `produtos`
  ...
  ADD UNIQUE KEY `Descreicao` (`Descreicao`);
